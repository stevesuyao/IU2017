...
## IU 2017
This has been adapted from [Feathers + React + Redux + Webpack + complete auth + offline mode (ideal for production)](https://github.com/bertho-zero/react-redux-universal-hot-example) with its setup instructions below. Please adopt the patterns present in the parent project, unless you believe they are done incorrectly and you can stand by your decision.

Follow these steps to complete this project:

1. [Clone or fork this repo](https://github.com/stevesuyao/IU2017).
2. Install all packages using 
```bash
npm install
```
3. Review the included [wireframe](./docs/designs/wireframes/iu.ppt) to get colors, styles, and other design considerations.

## About react-redux-universal-hot-example

[Feathers + React + Redux + Webpack + complete auth + offline mode (ideal for production)](https://github.com/bertho-zero/react-redux-universal-hot-example) is a starter boilerplate app using the following technologies:
